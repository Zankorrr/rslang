import {
  createUserWordFull, getUserStatistics, getUserWordFull, updateUserStatistics, updateUserWordFull,
 } from '../../core/api';
 import {
  IResult, IUserWordFull, IUserWordsStatistic, IWord,
 } from '../../core/types';
   ...
   if (localStorage.getItem('userToken') && localStorage.getItem('userId')) {
     ...
     try {
       ...
       if (flag) {
         ...
         updateUserStatisticBody.optional.sprint.allWords += 1;
         updateUserStatisticBody.optional.sprint.rightWords += 1;
         updateUserStatisticBody.optional.sprint.set += 1;
       } else {
       ...
       if (String(err) === 'Error: Not Found') {
         ...
         updateWordBody.optional.wordID = arrWords[num].id;
         updateUserStatisticBody.optional.sprint.newWords += 1;
